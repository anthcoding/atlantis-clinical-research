	...
	return (
		<div className="animate-[fadeIn_.4s_ease-in-out] w-11/12 mx-auto xxl:w-9/12 md:w-10/12 pt-[80px] lg:pt-[120px]">
			<div className="mx-auto mt-6 leading-none text-center h3 lg:w-4/6 text-secondaryDark">
				...
				<h6 className="mt-8 leading-normal text-center h6 text-secondaryDark">
				...
				<a href="mailto:atlantisclinicalresearch@gmail.com" className="relative flex mx-auto mt-10 h5 lg:h3 w-fit lg:mt-32 text-darkBlue">
					{' '}
