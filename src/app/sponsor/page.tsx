    ...
    <div className="w-9/12 mx-auto">
      <div className="w-9/12 md:w-5/12 mx-auto">
        ...
        <p className="text-center text-sm sm:text-md text-darkGray font-light">
          ...
          the fastest and acure quality data following the strict Good Clinical
          Practice Guideline.
          <br />
          <br />
          ...
          practices. All Atlantis Clinical Research PIs are Board-certified and
          are engaged in delivering a high standard of care.
        </p>
      </div>
      <Image
        src={GroupDoctors}
      ...
      <div className="w-full justify-between mt-52 ">
        ...
        <div className="flex flex-col md:flex-row justify-between ">
          ...
          <div className="w-full md:w-[35%]">
            <p className="text-center md:text-start text-sm sm:text-md text-darkGray font-light">
              We recruit study participants through an outstanding collaboration
              with primary care provider offices, community health facilities,
              and local media advertising. In all studies we have participated
              in, we have met and, in most, have far exceeded the enrollment
              targets.
            </p>
          </div>
        </div>
        ...
        <div className="mt-52">
          ...
          <div className="ml-auto w-[80%]">
            ...
            <h3 className="text-end mb-2 text-md md:text-lg text-darkGray font-light">
              <span className="font-bold">Free parking</span> for participants
              and monitors
            </h3>
            <h3 className="text-end mb-2 text-md md:text-lg text-darkGray font-light">
              {' '}
